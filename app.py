...
def query_gemma(question, context):
    """Query Google's Gemma 3 4B free model"""
    ...
    # Use Google Gemma 3 4B - EXACT MODEL NAME
...
ANSWER:"""
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"404 Error: Model {model} not found")
...
def try_alternative_model(question, context):
    """Try other free models if Gemma 3 fails"""
    alternative_models = [
    ...
    # Fallback response
    return "I have access to your PDFs but the AI service is currently unavailable. Please try again later."
